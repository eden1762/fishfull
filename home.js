  ...
  var copy = {
    zh: {
      ...
      nav: [
        ...
        { label: 'AR 遊戲', href: '/ar#fishfull-ar-stage' },
      ...
      qrHref: '/ar?demo=qr#fishfull-ar-stage',
      ...
      actions: [
        { tone: 'blue', href: '/ar?demo=qr#fishfull-ar-stage', number: '01', title: '掃碼試用', subtitle: '先看魚貨履歷範例與 AR 遊戲', badge: '最快上手', description: '適合魚攤、店家、活動現場。掃一下就知道這套服務怎麼幫客人看懂魚、找到料理與留下回饋。' },
        { tone: 'orange', href: '/ar#fishfull-ar-stage', number: '02', title: '玩 AR 遊戲', subtitle: '看完整 3D 魚、集點、學會怎麼問', badge: '主推功能', description: '把標籤變成拍照、選魚、料理與集點小任務。手機上先看到完整魚模型，再決定要不要買。' },
    ...
    en: {
      ...
      nav: [
        ...
        { label: 'AR Game', href: '/ar#fishfull-ar-stage' },
      ...
      routeEyebrow: 'START HERE',
      actions: [
        { tone: 'blue', href: '/ar?demo=qr#fishfull-ar-stage', number: '01', title: 'Scan Demo', subtitle: 'Try a sample catch card and AR game', badge: 'Fastest start', description: 'Useful for fish stalls, stores, markets, and events. One scan shows how FishFull helps shoppers understand a fish, cook it, and leave feedback.' },
        { tone: 'orange', href: '/ar#fishfull-ar-stage', number: '02', title: 'Play AR Game', subtitle: 'See the full 3D fish, collect points, and ask better questions', badge: 'Main feature', description: 'Labels become small missions that connect scanning, choosing, cooking, points, and feedback. On phones, the whole fish stays visible before you buy.' },
