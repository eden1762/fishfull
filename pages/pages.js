    ...
    map: {
      zh: {
        ...
        locations: [
          ...
          { id: 2, type: '餐廳', name: '圓通水產', area: '新北市中和區', address: '新北市中和區圓通路1號', lat: 24.99794, lng: 121.50185, species: '現流海鮮、刺身、熟食、海鮮料理', tag: '把好魚端上桌', note: '適合示範一道零失敗料理，讓「不知道怎麼煮」變成「我今天想試」。' },
