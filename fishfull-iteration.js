(function () {
  ...
  function injectStyle() {
    ...
    style.textContent = [
      ...
      '.fishfull-loop__card[href="' + arRoute + '"]{background:linear-gradient(150deg,rgba(255,255,255,.94),rgba(223,246,255,.92));border-color:rgba(16,132,168,.28);box-shadow:inset 0 0 0 1px rgba(255,255,255,.58)}',
