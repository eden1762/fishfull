(function () {
  ...
  var copy = {
    zh: {
      ...
      cards: [
        ...
        ['AR 選魚小教練', '手機先看完整 3D 魚身，再用綠／黃／紅燈號判斷，現場比較敢問也比較敢買。', '/ar.html#fishfull-ar-stage'],
    ...
    en: {
      ...
      cards: [
        ...
        ['AR Fish Coach', 'View the full 3D fish on your phone, then use green/yellow/red guidance to ask better and buy smarter.', '/ar.html#fishfull-ar-stage'],
  ...
  function injectStyle() {
    ...
    style.textContent = [
      ...
      '.fishfull-loop__card[href="/ar.html#fishfull-ar-stage"]{background:linear-gradient(150deg,rgba(255,255,255,.94),rgba(223,246,255,.92));border-color:rgba(16,132,168,.28);box-shadow:inset 0 0 0 1px rgba(255,255,255,.58)}',
